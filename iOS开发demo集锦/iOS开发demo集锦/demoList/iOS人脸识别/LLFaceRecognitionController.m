...
@interface LLFaceRecognitionController ()<FaceDetectorDelegate>
{
    UIImageView *imgView;
}
@end

@implementation LLFaceRecognitionController
...
- (void)viewDidLoad
{
    ...
    [self buttonWithTitle:@"人脸识别" frame:CGRectMake(100, 100, 150, 30) action:@selector(pushToFaceStreamDetectorVC) AddView:self.view];
