...
- (void)centralManagerDidUpdateState:(CBCentralManager *)central{
    ...
    switch (central.state) {
        case CBCentralManagerStateUnknown:
            ...
            .LeeTitle(@"提示")
            .LeeContent(@"CBCentralManagerStateUnknown")
            .LeeCancelAction(@"取消", ^{
        ...
        case CBCentralManagerStateResetting:
            ...
            [LEEAlert alert].config
            .LeeTitle(@"提示")
            .LeeContent(@"CBCentralManagerStateResetting")
            .LeeCancelAction(@"取消", ^{
        ...
        case CBCentralManagerStateUnsupported:
            ...
            [LEEAlert alert].config
            .LeeTitle(@"提示")
            .LeeContent(@"CBCentralManagerStateUnsupported")
            .LeeCancelAction(@"取消", ^{
        ...
        case CBCentralManagerStateUnauthorized:
            ...
            [LEEAlert alert].config
            .LeeTitle(@"提示")
            .LeeContent(@"CBCentralManagerStateUnauthorized")
            .LeeCancelAction(@"取消", ^{
        ...
        case CBCentralManagerStatePoweredOff:
            ...
            [LEEAlert alert].config
            .LeeTitle(@"提示")
            .LeeContent(@"CBCentralManagerStatePoweredOff")
            .LeeCancelAction(@"取消", ^{
        ...
        case CBCentralManagerStatePoweredOn:
            ...
            [LEEAlert alert].config
            .LeeTitle(@"提示")
            .LeeContent(@"CBCentralManagerStatePoweredOn")
            .LeeCancelAction(@"取消", ^{
